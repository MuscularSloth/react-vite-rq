...
import PaginationPostListPage from './pages/PaginationPostListPage/PaginationPostListPage.tsx';
    ...
    <>
      <Routes>
        <Route path={PATHS.POST} element={<GeneralLayout />}>
          ...
          <Route path={PATHS.PAGINATED_POST} element={<PaginationPostListPage />} />
